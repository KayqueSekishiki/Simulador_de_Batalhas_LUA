...
function actions.build()
    ...
    local bodyAttack = {
        ...
        execute = function(playerData, creatureData)
            ...
            if success then
                ...
                print(string.format("%s atacou %s e causou %d pontos de dano",creatureData.name, playerData.name, damage))
    ...
    local waitAction = {
        description = "Desdenhar",
        requirement = nil,
        execute = function(playerData, creatureData)
            print(string.format("%s decidiu desdenhar de %s e não realizou um ataque.", creatureData.name, playerData.name))
        end
    }
